<script lang="ts">
  // WhatsApp number (change to actual number)
  const whatsappNumber = '6281228336650'; // Format: country code + number (no + or spaces)
  const message = 'Hello, I am interested in Primari Corpora products.';
